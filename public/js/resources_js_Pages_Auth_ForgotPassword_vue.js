...
var render = function() {
  ...
  return _c("div", { staticClass: "columns is-centered is-vcentered" }, [
    _c(
      "div",
      { staticClass: "column box is-3" },
      [
        _c(
          "b-notification",
          {
            attrs: {
              active: _vm.status !== null,
          ...
          "form",
          {
            on: {
              submit: function($event) {
                ...
                return _vm.form.post("/forgot-password")
              }
            }
          },
          [
            ...
            _c(
              ...
              [
                _c(
                  "inertia-link",
                  {
                    staticClass: "is-flex is-align-self-center",
